...
const recommendationTemplate = `
    ...
    If the user wants to watch something like another movie, don't recommend the same movie as the user talks about and recommend one with a similar plot.
...
const chain = RunnableSequence.from([
    ...
    },
    {
      ...
      conv_history: ({ original_input }) => {
        console.log("chain Conversation History: ", original_input.conv_history)
...
// console.log("standaloneStatementPrompt ",standaloneStatementPrompt)
export {
    // standaloneStatementTemplate, 
    // standaloneStatementPrompt,
    // recommendationPrompt,
    // standaloneStatementChain,
    chain }
